...
public class DateUtilLeapYearShould {
    ...
    @Test
    public void return_true_when_years_is_divisible_by_400() {


        assertThat(DateUtil.isLeapYear(1600), is(true));//se uso un static import
    ...
    public void return_false_when_year_is_divisible_by_100_but_not_by_400() {
        ...
        assertThat(DateUtil.isLeapYear(1700), is(false));//se uso un static import
    ...
    public void return_true_when_year_is_divisible_by_4_but_not_by_100() {
        ...
        assertThat(DateUtil.isLeapYear(1996), is(true));//se uso un static import
...
@Test
    public void return_false_when_year_is_not_divisible_by_4() {
        ...
        assertThat(DateUtil.isLeapYear(2017), is(false));//se uso un static import
